...
// MARK: - Enforces Term compliance to Comparable protocol by comparing termInt and year to determine Term equality. Any term with a nil year or termInt is considered the smallest possible Term value
