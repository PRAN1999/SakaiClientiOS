...
class ResourceNode {
    ...
    /// Recursively construct an array of child ResourceNode's given the flattened subtree and a given number of
    /// children
    ///
    /// - Parameters:
    ...
    static func constructTree(data: [ResourceItem], numChildren: Int) -> [ResourceNode]? {
        ...
        for _ in 0..<numChildren {
            ...
            case .collection(let size):
                ...
                // Recursively construct the child subtrees based on the number of direct children in the collection
                // and the children data slice
