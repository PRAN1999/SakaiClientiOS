...
class HideableTableSource<Provider: HideableDataProvider, Cell: UITableViewCell & ConfigurableCell> : ReusableTableSource<Provider, Cell>, UIGestureRecognizerDelegate where Cell.T == Provider.T {
