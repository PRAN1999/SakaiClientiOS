...
class FormatBarController: NSObject {
    ...
    func toggleHeader(fromItem item: FormatBarItem) {
        ...
        let selectedIndex = RichTextSubmissionView.Constants.headers.index(of: headerLevelForSelectedText())
    ...
    func toggleList(fromItem item: FormatBarItem) {
        ...
        if let listType = listTypeForSelectedText() {
            index = RichTextSubmissionView.Constants.lists.index(of: listType)
        }
